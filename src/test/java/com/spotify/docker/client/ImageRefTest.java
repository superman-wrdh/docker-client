...
public class ImageRefTest {
  ...
  public void testRegistryUrl() throws Exception {
    ...
    assertThat(new ImageRef("registry.example.net/foo/bar"),
        hasRegistryUrl("http://registry.example.net"));
    ...
    assertThat(new ImageRef("registry.example.net:5555/foo/bar:latest"),
        hasRegistryUrl("http://registry.example.net:5555"));
  }
  ...
  public void testParseUrl() throws Exception {
    ...
    assertThat(parseRegistryUrl("registry.net"), equalTo("http://registry.net"));
    assertThat(parseRegistryUrl("registry.net:80"), equalTo("http://registry.net:80"));
  }
